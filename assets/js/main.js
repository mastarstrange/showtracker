...
//#Changing the default location of listnav
$(".listNav").prependTo(".taglist");
...
const userDetails = {
  ...
  emails: ["thuvaragan28@gmail.com", "test2@gmail.com", "test3@gmail.com", "test4@gmail.com", "test5@gmail.com"],
  pass: ["123", "456", "789", "abc", "abc123"],
}

//? Altering Between Login and Signup Pages
//? >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
// swpLogIn.onclick = function(){
...
btnSignUp.onclick = function() {
  ...
  if((/\d/.test(nname)) || (nname.length <= 5) || (/[ -/:-@[-`{-~]/.test(nname))){
    ...
    if(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(nemail)) {
      ...
      if((/[A-Z]/.test(npass)) && (/[a-z]/.test(npass)) && (/[0-9]/.test(npass)) && (/[0-9]/.test(npass)) && (/[ -/:-@[-`{-~]/.test(npass)) && (npass.length == 8)){
...
let passBlur = function(){
  ...
  } else if(!((/[A-Z]/.test(npass)) && (/[a-z]/.test(npass)) && (/[0-9]/.test(npass)) && (/[0-9]/.test(npass)) && (/[ -/:-@[-`{-~]/.test(npass)) && (npass.length == 8))){
